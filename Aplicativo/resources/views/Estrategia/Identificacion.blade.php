...
<div class="container-fluid">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <div class="align-items-center">
                        <h5 class="font-weight-bold text-primary m-0">IDENTIFICACIÓN DE ESTRATEGIAS </h5>
                    </div>
                </div>
    ...
    <div class="floating-nav-container">
        <div class="nav-buttons">
            <a href="/analisis/came/{{ $PlanId }}" class="btn-nav btn-nav-prev" id="prevBtn">
                <i class="fas fa-arrow-left"></i> Anterior
            </a>
            <a href="/plan/detalle/{{ $PlanId }}"  class="btn-nav btn-nav-next" id="nextBtn">
