...
INSERT IGNORE INTO `amenazas` (`Id`, `UsuarioId`, `PlanId`, `Amenaza`, `Accion`, `Origen`) VALUES
...
INSERT IGNORE INTO `cadena_valor` (`Id`, `PlanId`, `Pregunta`, `Valor`) VALUES
	(1, 15, 'P1', 4),
	(2, 15, 'P2', 3),
	(3, 15, 'P3', 2),
	(4, 15, 'P4', 3),
...
INSERT IGNORE INTO `came` (`Id`, `PlanId`, `Tipo`, `Accion`) VALUES
...
INSERT IGNORE INTO `colaboradores` (`Id`, `PlanId`, `UsuarioId`) VALUES
	(1, 15, 6),
	(2, 15, 7);
...
INSERT IGNORE INTO `competidores` (`Id`, `UsuarioId`, `PlanId`, `Competidor`, `ProductoId`, `Venta`) VALUES
	(1, 5, 15, 1, 1, 9),
	(2, 5, 15, 1, 2, 19),
	(3, 5, 15, 1, 3, 29),
	(4, 5, 15, 1, 4, 39),
...
INSERT IGNORE INTO `debilidades` (`Id`, `UsuarioId`, `PlanId`, `Debilidad`, `Accion`, `Origen`) VALUES
...
INSERT IGNORE INTO `detalle_estrategia` (`Id`, `Relacion`, `Tipo`, `Descripcion`) VALUES
...
INSERT IGNORE INTO `edgs` (`Id`, `UsuarioId`, `PlanId`, `Periodo`, `ProductoId`, `Valor`) VALUES
	(1, 5, 15, 2016, 1, 10.00),
	(2, 5, 15, 2016, 2, 0.00),
	(3, 5, 15, 2016, 3, 0.00),
	(4, 5, 15, 2016, 4, 0.00),
...
INSERT IGNORE INTO `empresa` (`Id`, `Nombre`, `Descripcion`, `Mision`, `Vision`) VALUES
...
INSERT IGNORE INTO `estrategia_plan` (`Id`, `PlanId`, `RelacionEstrategia`) VALUES
	(1, 10, 'FO'),
	(2, 15, 'FA');
...
INSERT IGNORE INTO `foda` (`Id`, `PlanId`, `Tipo`, `Codigo`, `Valor`) VALUES
	(137, 15, 'FO', 'F1O1', 4),
	(138, 15, 'FO', 'F1O2', 3),
	(139, 15, 'FO', 'F1O3', 2),
	(140, 15, 'FO', 'F1O4', 4),
...
INSERT IGNORE INTO `fortalezas` (`Id`, `UsuarioId`, `PlanId`, `Fortaleza`, `Accion`, `Origen`) VALUES
...
INSERT IGNORE INTO `fuerzas_porter` (`Id`, `UsuarioId`, `PlanId`, `Fuerza`, `Valor`) VALUES
	(1, 5, 15, 'F1S1', 5),
	(2, 5, 15, 'F1S2', 4),
	(3, 5, 15, 'F1S3', 3),
	(4, 5, 15, 'F1S4', 2),
...
INSERT IGNORE INTO `objetivo_especifico` (`Id`, `UsuarioId`, `PlanId`, `ObjGeneral_Id`, `Tipo`, `Objetivo`) VALUES
	...
	(3, 5, 15, 2, 'Operativo', 'Migrar el 100% de los servidores a energía renovable en 12 meses'),
	(4, 5, 15, 2, 'Funcional', 'Implementar una política de teletrabajo híbrido que reduzca viajes en un 30%'),
	(7, 5, 15, 4, 'Funcional', 'Establecer alianzas con 5 empresas de logística regional en el primer año'),
	(8, 5, 15, 4, 'Funcional', 'Desarrollar una versión localizada de LogiVerde para mercados de Centroamérica'),
	(9, 5, 15, 1, 'Operativo', 'Reducir el costo de entrada de las soluciones en un 15% mediante economías de escala'),
	(10, 5, 15, 2, 'Operativo', 'Medir y reportar la huella de carbono corporativa trimestralmente'),
	(11, 5, 15, 4, 'Operativo', 'Participar en 4 ferias internacionales de logística sostenible por año');
...
INSERT IGNORE INTO `objetivo_general` (`Id`, `UnidadId`, `Objetivo`) VALUES
...
INSERT IGNORE INTO `oportunidades` (`Id`, `UsuarioId`, `PlanId`, `Oportunidad`, `Accion`, `Origen`) VALUES
...
INSERT IGNORE INTO `periodos` (`Id`, `UsuarioId`, `PlanId`, `Periodo`) VALUES
	(9, 5, 15, 2020),
	(11, 5, 15, 2017),
	(12, 5, 15, 2018),
	(13, 5, 15, 2019),
...
INSERT IGNORE INTO `pest` (`Id`, `UsuarioId`, `PlanId`, `Codigo`, `Valor`) VALUES
	(1, 5, 15, 'P1', 0),
	(2, 5, 15, 'P2', 1),
	(3, 5, 15, 'P3', 2),
	(4, 5, 15, 'P4', 3),
...
INSERT IGNORE INTO `plan_estrategico` (`Id`, `Fecha`, `UsuarioId`, `Contenido`, `Conclucion`) VALUES
...
INSERT IGNORE INTO `preguntas_cv` (`Id`, `Codigo`, `Pregunta`) VALUES
...
INSERT IGNORE INTO `preguntas_fp` (`Id`, `Codigo`, `Perfil`, `Hostil`, `Favorable`) VALUES
...
INSERT IGNORE INTO `preguntas_pest` (`Id`, `Codigo`, `Pregunta`) VALUES
...
INSERT IGNORE INTO `productos` (`Id`, `UsuarioId`, `PlanId`, `Nombre`, `Ventas`, `Porcentaje`) VALUES
...
INSERT IGNORE INTO `tcm` (`Id`, `UsuarioId`, `PlanId`, `Periodo`, `ProductoId`, `Valor`) VALUES
	(1, 5, 15, 2016, 1, 1.00),
	(2, 5, 15, 2016, 2, 9.00),
	(3, 5, 15, 2016, 3, 10.00),
	(4, 5, 15, 2016, 4, 5.00),
...
INSERT IGNORE INTO `unidad_estrategica` (`Id`, `Unidad`) VALUES
...
INSERT IGNORE INTO `usuario` (`Id`, `Nombre`, `Apellido`, `Correo`, `password`, `Avatar`, `Rol`, `Estado`) VALUES
...
INSERT IGNORE INTO `valores` (`Id`, `Valor`) VALUES
	(1, 'Sostenibilidad'),
